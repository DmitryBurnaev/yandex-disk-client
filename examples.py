...
class ExamplesOfUsingOfYandexDiskRestClient:
    ...
    def get_meta_of_folder(self):
        try:
            directory = self.client.get_directory(self.random_name_of_folder)
    ...
    def remove_folder_or_file(self):
        try:
            self.client.remove(self.random_name_of_folder)
    ...
    def copy_folder_of_file(self):
        try:
            self.client.copy("/" + self.random_name_of_child_folder,
